...
simrOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "simrOptions",
...
simrResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "simrResults",
...
simrBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "simrBase",
