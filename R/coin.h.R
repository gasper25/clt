...
coinOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "coinOptions",
...
coinResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "coinResults",
...
coinBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "coinBase",
